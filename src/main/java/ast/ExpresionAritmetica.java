...
public abstract class ExpresionAritmetica {
	...
	public static ExpresionAritmetica generate(Random random, int min, int max) {
		...
		//Non terminals
			case 2: return Multiplicacion.generate(random, min-1, max-1);
			case 3: return Suma.generate(random, min-1, max-1);
			case 4: return Resta.generate(random, min-1, max-1);
